...
{{-- Setup Data SEO (Safe Null Coalescing) --}}
@php
    $seo = $model?->seo;
@endphp
...
<div x-data="{ 
    ...
    <div class="p-6">
        ...
        <div x-show="activeTab === 'general'" class="space-y-5">
            ...
            {{-- CANONICAL URL (Universal - Gak perlu translate biasanya) --}}
        ...
        {{-- Image biasanya universal (satu gambar buat semua bahasa) --}}
                ...
                <div class="w-full md:w-72">
                    ...
                    <div class="border border-gray-200 rounded-lg overflow-hidden bg-gray-50">
                        ...
                        <div class="p-3 bg-white">
                            ...
                            {{-- Preview title ikut bahasa yang dipilih --}}
