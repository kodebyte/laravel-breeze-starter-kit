<x-admin.layouts.app title="Menu Management">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        {{-- ================================================= --}}
        {{-- KOLOM KIRI: SUMBER MENU (ADD ITEMS) --}}
        {{-- Hanya tampil jika user boleh CREATE --}}
        {{-- ================================================= --}}
        @can('menus.create')
            <div class="space-y-6">
        ...
        {{-- Logic Layout: Kalau gak bisa create, dia jadi Full Width (col-span-3) --}}
        {{-- ================================================= --}}
        <div class="{{ auth()->user()->can('menus.create') ? 'lg:col-span-2' : 'lg:col-span-3' }}">
            <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden min-h-[600px] flex flex-col">
                ...
                <div class="p-6 border-b border-gray-100 flex items-center justify-between">
                    ...
                    {{-- TOMBOL SAVE POSITION (Hanya jika boleh UPDATE) --}}
                    @can('menus.update')
                ...
                </div> {{-- 1. Tutup Content P-6 --}}
            </div>     {{-- 2. Tutup Card White --}}
        </div>         {{-- 3. Tutup Kolom Kanan --}}
    </div>             {{-- 4. Tutup Grid Utama --}}
    ...
    @push('scripts')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const canUpdate = {{ auth()->user()->can('menus.update') ? 'true' : 'false' }};
