                ...
                <div>
                    ...
                    <div class="flex items-center gap-2 mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500">Define the name of the role.</p>
                        </div>
                    </div>
                    ...
                    <div class="max-w-xl">
                        <x-admin.form.group label="Role Name" name="name" required>
                            <x-admin.form.input name="name" placeholder="e.g. Super Admin, HR Manager, Editor" required autofocus />
                        </x-admin.form.group>
                    </div>
                </div>
                ...
                <div>
                    <div class="flex items-center gap-2 mb-6">
                        <div class="p-2 bg-purple-50 text-purple-600 rounded-lg">
                            {{-- Pake Icon Key (Access) --}}
                            <x-admin.icon.key class="w-5 h-5" />
                        </div>
                        <div>
                            <h3 class="font-bold text-gray-900">Access Permissions</h3>
                            <p class="text-xs text-gray-500">Select which capabilities this role should have.</p>
                        </div>
                    </div>

                    {{-- LOGIC GROUPING PERMISSIONS --}}
                    @php
                                        ...
                                        <label class="flex items-center space-x-2.5 cursor-pointer group">
                                            <div class="relative flex items-center">
                                                <input type="checkbox" 
                                                       ...
                                                       class="peer h-4 w-4 rounded border-gray-300 text-purple-600 focus:ring-purple-500 cursor-pointer transition ease-in-out duration-150">
                                            </div>
                                            {{-- Clean Label: users.create -> Create --}}
                                            <span class="text-sm text-gray-600 group-hover:text-gray-900 font-medium select-none capitalize transition-colors">
